...
- Use the lunar Go2-style best-evaluation policy in the robust Spot grasp demo
...
- Fix MJCF transparent geoms so `rgba` alpha 0 hides viewer rendering while preserving collision
...
- Fix MJCF heightfields losing material color, texture, and texture repetition when rendered in Newton viewers
